...
export const metadata: Metadata = {
  ...
  description:
    '蜂神榜 Ai 教育管理平台整合四大系統：94Manage 補習班學員管理、94inClass AI 點名系統、94Stock 教材庫存管理、94Bot 補習班助手 Telegram AI 助手。專為台灣補習班、才藝教室、連鎖教育機構設計，免費試用。',
  keywords:
    '補習班管理系統, 補習班點名系統, 補習班庫存管理, 補習班AI助手, Telegram機器人, 學員管理系統, NFC點名, AI點名, 教育管理平台, 補習班軟體, 才藝教室管理, 安親班管理, 蜂神榜, 94cram, 94Bot',
