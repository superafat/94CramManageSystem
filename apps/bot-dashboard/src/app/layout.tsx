...
export const metadata: Metadata = {
  ...
  description:
    '蜂神榜 AI 補習班助手系統 是補習班專屬 Telegram AI 助手。千里眼協助老師用自然語言操作點名、繳費、庫存；順風耳讓家長即時掌握孩子出缺勤與成績。免費開始使用。',
  keywords:
    '補習班AI助手, Telegram機器人, 補習班管理, 自然語言操作, 家長通知, 出缺勤查詢, 成績推播, 蜂神榜 AI 補習班助手系統, 千里眼, 順風耳, 蜂神榜',
  authors: [{ name: '蜂神榜 Ai 教育科技' }],
  openGraph: {
    title: '蜂神榜 AI 補習班助手系統 AI 助手 | 千里眼 x 順風耳',
    description: '補習班智慧雙引擎 — 千里眼讓老師用對話操作系統，順風耳讓家長即時掌握孩子動態。',
    type: 'website',
    locale: 'zh_TW',
    siteName: '蜂神榜 AI 補習班助手系統 AI 助手',
  },
  twitter: {
    card: 'summary_large_image',
    title: '蜂神榜 AI 補習班助手系統 AI 助手',
